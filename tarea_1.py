...
class NueveCuartos(entornos_o.Entorno):
    ...
    def transición(self, acción):
        ...
        if acción is "limpiar":
            ...
            self.desempeño -= 2
        elif acción is "ir_Derecha" and robot is "A" and piso is "segundo_piso":
            self.x[0] = "B"
            self.desempeño -= 1
        elif acción is "ir_Derecha" and robot is "B" and piso is "segundo_piso":
            self.x[0] = "C"
            self.desempeño -= 1
        elif acción is "ir_izquierda" and robot is "C" and piso is "segundo_piso":
            self.x[0] = "B"
            self.desempeño -= 1
        elif acción is "ir_izquierda" and robot is "B" and piso is "segundo_piso":
            self.x[0] = "A"
            self.desempeño -= 1
        elif acción is "subir" and robot is "C" and piso is "segundo_piso":
            self.x[1] = "tercer_piso"
            self.desempeño -= 2
        elif acción is "ir_Derecha" and robot is "A" and piso is "tercer_piso":
            self.x[0] = "B"
            self.desempeño -= 1
        elif acción is "ir_Derecha" and robot is "B" and piso is "tercer_piso":
            self.x[0] = "C"
            self.desempeño -= 1
        elif acción is "ir_izquierda" and robot is "C" and piso is "tercer_piso":
            self.x[0] = "B"
            self.desempeño -= 1
        elif acción is "ir_izquierda" and robot is "B" and piso is "tercer_piso":
            self.x[0] = "A"
            self.desempeño -= 1
